...
struct ProductListUseCase {
    ...
    public func getProductList(with paginationValue: Any?, sortingValue: SortingValue, keyPhrase: String? = nil, reverse: Bool, _ callback: @escaping RepoCallback<[Product]>) {
