...
struct SegueIdentifiers {
    ...
    static let toFailureCheckout = "toFailureCheckout"
    ...
    static let toCheckoutAddressList = "toCheckoutAddressList"
    static let toAccountAddressList = "toAccountAddressList"
