#
#  Be sure to run `pod spec lint ShopClient_Shopify.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Mykola Voronin"
  # s.authors            = { "Mykola Voronin" => "nvoronin@rubygarage.org" }
  # s.social_media_url   = "http://twitter.com/Mykola Voronin"
  ...
  # s.weak_frameworks  = "ShopClient_Gateway"
  # s.frameworks = "MobileBuySDK"
